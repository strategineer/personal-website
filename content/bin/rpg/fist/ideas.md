...
## Warvey Heinstein's Island Retreat

MissionPrompt: Pirates take over an island of civilians / Reward: ...: 11.11 / Reward: 1D6 CYCLOPS gadgets / TheDossierSays: An outlandish cult / IsTryingTo: Convert an abandoned structure / WhichWill: Spread a horrible illness / But: A superhero aims to stop them

BOOTY have taken over the private island of pedo-cum-movie-producer Warvey Heinstein (Mansion) and is looking to sacrifice the people on the island to their (old) god in an attempt to submerge the island back into the sea where it belongs.
...
Objective: 
- Extract Jordan Cane (Lighthouse), the retired FBI agent turned actor, from the island.
- Recover Heinstein's collection of CYCLOPS gadgets
- Sabotage ANVIL operatives attempt to extract Warvey Heinstein.
...
1. Yacht: 1 CYCLOPS gadget.
2. Village: Homes for the help and the trafficked. Pirates are keeping everyone inside. 
3. Forest Dock: Jordan Cane (FBI) waiting for extraction at the dock.
...
5. Port: Pirates's heavily guarded boats docked.
6. Mansion: 1 CYCLOPS gadget. Red alert engaged, Heinstein's with a handful of his guards are on lockdown, waiting for help to arrive.
7. Lagoon: Contains a secret entrance to the Mansion [6] and the Yacht [1]. 
8. Lighthouse: Prime sniping position. Captain of Heinstein's guard located here. 
9. Security Room: Vacant but contains closed circuit TVs to view the security cameras surveying the whole island.  
...
- Heinstein's head of security (Lagoon) can be collaborated with. He's expecting to collaborate with ANVIL operatives but is willing to work with FIST if their objectives align with his (rescuing Heinstein).
...
- ANVIL operatives (Mansion, exterior).
- Heinstein's Guards (Mansion, interior)