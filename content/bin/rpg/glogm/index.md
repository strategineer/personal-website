...
3. In GLOGM, all PCs are **[Wizards](#wizard-class)** at level 1! Choose a Wizard School [from Many Rats on a Stick](#choosing-a-wizard-school-option-1) OR [from the rest of the GLOG-osphere](#choosing-a-wizard-school-option-2).
...
{{< glogm >}} All PCs start at level 1 with Template A of the Wizard class with a Wizard School of their choice to represent their innate capability to cast spells. Unlike NPCs, who may or may not ever learn to unlock their innate magical power potential. {{< /glogm >}}
