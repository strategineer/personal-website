...
- When constructing buildings, you can hold **SHIFT** while dragging to place many of them in a line. This is especially useful for solar collectors, allowing you to easily connect your metal extractors into an "Overdrive" network increasing their efficiency. You can **Z** and **X** to change the spacing between each of them (and you should because destroyed buildings explode and damage nearby buildings).
...
- Use **Z** to select any idle constructors on the map, including your commander.
  - If your commmander is idle, keep expanding with it.
  - If you've got idle constructors:
    - Send them out to help your commander expand.
    - Send them out to expand on a different front with some units guarding them.
    - Protect your backline with some static defenses.
    - Start connecting your metal extractors onto an energy network to leverage the Overdrive system.
  - Otherwise, if you've got unused metal piling up in your reserves, build more constructors to make use of it.
- Shields are cool but damage is much cheaper and so use static shields sparingly and only to protect your most valuable buildings/units. Shields are good on their own but they really shine when used in combination with anti-air units/defenses and an Antinuke.
  ...
  - Shields (other than the "personal" shields of the Convict, Thug and Felon Shieldbots) cost energy to recharge and thus might negatively impact your economy if not accounted for.
