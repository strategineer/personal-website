...
I've learned a lot about GMing since my first very poor attempt at it sometime in the mid-00s. Read on some more context on my roleplaying history, otherwise [you can go straight to the lessons I learned](#lessons-i-learned).

I've loved the platonic ideal of tabletop roleplaying forever but up until the past few years I participated in it sporadically. This changed in early 2019 when I found myself unemployed and with ample free time to explore hobbies and passions that I had neglected for a long time, including tabletop roleplaying.
...
Foundry is super customizable, you can play just about anything with it. Setting it up just right did take me a few hours but that was time well spent because running sessions with Foundry is such an amazing hassle free experience. It just works. If the game you're playing is well supported then everything is handled by the computer and so you and your players can focus on roleplaying your characters instead of constantly worrying about what dice you need to be rolling.

# Bringing your characters to life with unique voices adds a lot to the roleplaying experience

I've always been curious about voice acting but I've never put in the time and effort needed to be good at it. Now that I've put in some the required time and effort, I'm still NOT good at it BUT I'm confident enough in my poor voice acting abilities to use them...

With my most recent campaign I made a commitment to try to give each NPC I embody a unique vocal quirk/sound. My players seem to get a kick out of me doing this despite my relative inexperience which is a plus. And, even slightly changing my voice allows for my online players to more easily differentiate between me speaking as the GM and me speaking as an NPC which makes it much easier for me to go back and forth between the two.
...
The characters my players created for this campaign were top notch and were universally a great fit for the setting of the campaign, I take partial credit for this because I gave my players all the context they needed to create great characters for the world I was looking to build.
...
# Force players to think about relationships between their characters and the setting during character creation

Some tabletop roleplaying systems enforce this kind of relationship building as a core part of the character creation process but not all of them do. Even if I'm using a tabletop system that doesn't explicitly call for this (like the Shadowdark RPG rules for example), in the future I'll likely house rule it anyway because it's so useful.

Each player character starting off with a pre-existing relationship with at least one other PC as well as one NPC can provide a solid foundation for the player to roleplay their character right from the start and to give something for the GM to build on before anything even happens during the first session of a campaign (the relationship a PC has with an NPC defined during the character creation process can lead to a recurring NPC for example).

These relationships tie the PCs together initially and grounds them within the game world. As the GM, you can use these initial relationships as the foundation for further integrating these characters in the world.
...
I've been using this system in my most recent campaign and it's been working as expected. By design it creates a helpful feedback loop where players are given ample opportunity to say what's working for them and what isn't so that as a GM I can change subsequent sessions accordingly and be confident that everyone's is having as much fun as possible.

Considering how much effort goes into the GMing process, having players spend a few minutes at the end of each session is a small ask with benefits for my own sanity and their own enjoyment of the game. This system is simple but it's crazy how effective it is in both making me confident that as a group we're optimizing for fun and every session is building on the previous one in a way that everybody likes.
...
The process of writing post-session summaries has helped me recognize and helped me to remember all the notable, cool, interesting moments and decisions players made during a session. This process makes it much easier for me to come up with ideas and [bangs](#bangs) to insert into subsequent sessions.
...
In previous campaigns, I'd try to write down important moments during the session but I found that running a session and taking extensive notes was too much for my small brain to handle. For whatever reason, after the session is over I've found it much easier to write down a summary...
